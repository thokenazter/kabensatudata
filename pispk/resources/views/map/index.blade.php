...
<body>
    <nav class="navbar">
        ...
        <div class="navbar-links" id="navbarLinks">
            <a href="#" onclick="navigateToVillage(1)" class="text-white hover:bg-blue-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Kabalsiang</a>
            <a href="#" onclick="navigateToVillage(2)" class="text-white hover:bg-blue-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Benjuring</a>
            <a href="#" onclick="navigateToVillage(3)" class="text-white hover:bg-blue-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Kompane</a>
            <a href="#" onclick="navigateToVillage(4)" class="text-white hover:bg-blue-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Kumul</a>
            <a href="#" onclick="navigateToVillage(5)" class="text-white hover:bg-blue-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Batuley</a>
        </div>
    </nav>
    ...
    <!-- Custom JavaScript akan ditambahkan di langkah berikutnya -->
    <script>

        // Koordinat desa (akan diubah nanti)
        const villageCoordinates = [
            { lat: -5.7465, lng: 134.797032 }, // Desa Kabalsiang
            { lat: -5.7425, lng: 134.800000 }, // Desa Benjuring
            { lat: -5.7495, lng: 134.795000 }, // Desa Kumul
            { lat: -5.7515, lng: 134.798000 }, // Desa Batuley
            { lat: -5.7445, lng: 134.793000 }  // Desa Kompane
        ];
        
        // Fungsi untuk navigasi ke desa
        function navigateToVillage(villageId) {
            const index = villageId - 1;
            if (index >= 0 && index < villageCoordinates.length) {
                const coords = villageCoordinates[index];
                mymap.setView([coords.lat, coords.lng], 16);
                
                // Update active state
                if (activeVillageLink) {
                    activeVillageLink.classList.remove('active');
                }
                activeVillageLink = document.querySelectorAll('.village-link')[index];
                activeVillageLink.classList.add('active');
                
                // Pada tampilan mobile, tutup navbar setelah navigasi
        ...
        // Fungsi untuk memuat dan menampilkan marker
                    ...
                    markers = buildings.map(building => {
                        ...
                        .bindPopup(`
                            <div class="custom-popup">
                                ...
                                <button class="popup-detail-button" onclick="showBuildingDetails(${building.id})">
                                    Lihat Detail
                                </button>
                            </div>
                        `);
...
// Fungsi untuk memformat data yang diblur
function formatBlurredContent(building) {
    return `

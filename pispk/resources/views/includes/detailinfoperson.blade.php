    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8"> 
        ...
        <div class="mt-4">
            ...
            {{-- <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="p-6">
                        <div class="text-lg font-medium text-gray-900">Total Keluarga</div>
                        <div class="mt-2 text-3xl font-bold">{{ $totalFamilies }}</div>
                    </div>
                </div>
                
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="p-6">
                        <div class="text-lg font-medium text-gray-900">Total Anggota Keluarga</div>
                        <div class="mt-2 text-3xl font-bold">{{ $totalMembers }}</div>
                    </div>
                </div> --}}

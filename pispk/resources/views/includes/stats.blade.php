                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd>
                                    <div class="text-2xl font-bold text-gray-900">
                                        {{ number_format($stats['total_families']) }}
                                    </div>
                                </dd>
                            </dl>
                        </div>
                                    ...
                                    <div class="hidden group-hover:block absolute z-50 mt-2 w-full sm:w-96 tright-0 sm:right-0 transform sm:origin-top-right">
                                        <div class="bg-white rounded-lg shadow-xl border border-gray-200 p-4 max-h-96 overflow-y-auto">
                                            ...
                                            <div class="pb-3 mb-3 border-b border-gray-200">
                                                <h3 class="text-lg font-semibold text-gray-900">Detail Kasus TBC ({{ count($tbcCases) }} orang)</h3>
                                            </div>
                                ...
                                <dd class="group relative">
                                    ...
                                    <div class="hidden group-hover:block absolute z-50 mt-2 w-full sm:w-96 right-0 sm:right-0 transform sm:origin-top-right">
                                        <div class="bg-white rounded-lg shadow-xl border border-gray-200 p-4 max-h-96 overflow-y-auto">
                                            <!-- Header tooltip -->
                                            <div class="pb-3 mb-3 border-b border-gray-200">
                                                <h3 class="text-lg font-semibold text-gray-900">Detail Kasus Hipertensi ({{ count($hypertensionCases) }} orang)</h3>
                                            </div>
                                            ...
                                            <div class="space-y-4">
                                                @foreach($hypertensionCases as $case)
                                                    <div class="p-3 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors duration-200">
                                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                                            <div class="col-span-1 sm:col-span-2"><strong>Nama:</strong> @auth {{ $case->name }} @else <span class="blur-sm">[Login Sebagai Staf]</span> @endauth</div>
                                            ...
                                            <!-- Footer pagination -->
                                            @if(count($hypertensionCases) > 10)
                                                <div class="pt-3 mt-3 border-t border-gray-200 text-center">
                                                    <p class="text-sm text-blue-600 font-medium">
                                                        Menampilkan 10 dari {{ $stats['hypertension_count'] }} kasus
                                                    </p>
                                                </div>
                                            @endif
                                        </div>

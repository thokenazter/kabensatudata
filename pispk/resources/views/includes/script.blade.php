<script>
    ...
    // Water Distribution Chart
            ...
            data: {
                ...
                datasets: [{
                    data: [
                        ...
                        {{ $stats['total_families'] - $sanitationStats['clean_water_count'] }},
            ...
            data: {
                ...
                datasets: [{
                    data: [
                        ...
                        {{ $stats['total_families'] - $sanitationStats['toilet_count'] }},
        ...
        const jknByVillageChart = new Chart(jknByVillageCtx, {
            type: 'bar',
            data: {
                labels: {!! json_encode($jknByVillage->pluck('name')) !!},
                datasets: [{
                    label: 'Memiliki JKN',
                    data: {!! json_encode($jknByVillage->pluck('jkn_count')) !!},
        ...
        const jknOverviewChart = new Chart(jknOverviewCtx, {
            ...
            data: {
                ...
                datasets: [{
                    data: [
                        {{ $jknStats['jkn_count'] }}, 
                        {{ $jknStats['total_members'] - $jknStats['jkn_count'] }}
                    ],
                    backgroundColor: [
                        'rgba(75, 192, 192, 0.6)',
                        'rgba(255, 99, 132, 0.6)'

                                    ...
                                    <div class="hidden group-hover:block absolute z-50 mt-2 w-full sm:w-96 tright-0 sm:right-0 transform sm:origin-top-right">
                                        <div class="bg-white rounded-lg shadow-xl border border-gray-200 p-4 max-h-96 overflow-y-auto">
                                            ...
                                            <div class="pb-3 mb-3 border-b border-gray-200">
                                                <h3 class="text-lg font-semibold text-gray-900">Detail Pengguna KB ({{ count($kbCases) }} orang)</h3>
                                            </div>
                                                ...
                                                @foreach($kbCases as $case)
                                                    <div class="p-3 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors duration-200">
                                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                                            <div class="col-span-1 sm:col-span-2"><strong>Nama:</strong> @auth {{ $case->name }} @else <span class="blur-sm">[Login Sebagai Staf Puskesmas]</span> @endauth</div>
                                                            <div><strong>Desa:</strong> @auth {{ $case->family->building->village->name }} @else <span class="blur-sm">[********]</span> @endauth</div>
                                                            <div><strong>No. Bangunan:</strong> @auth {{ $case->family->building->building_number }} @else <span class="blur-sm">[********]</span> @endauth</div>
                                            ...
                                            <!-- Footer pagination -->
                                            @if(count($kbCases) > 10)
                                                <div class="pt-3 mt-3 border-t border-gray-200 text-center">
                                                    <p class="text-sm text-blue-600 font-medium">
                                                        Menampilkan 10 dari {{ $stats['tbc_count'] }} kasus
                                                    </p>
                                                </div>
                                            @endif
                                        </div>
                                ...
                                <dd class="group relative">
                                    ...
                                    <div class="hidden group-hover:block absolute z-50 mt-2 w-full sm:w-96 tright-0 sm:right-0 transform sm:origin-top-right">
                                        <div class="bg-white rounded-lg shadow-xl border border-gray-200 p-4 max-h-96 overflow-y-auto">
                                            <!-- Header tooltip -->
                                            <div class="pb-3 mb-3 border-b border-gray-200">
                                                <h3 class="text-lg font-semibold text-gray-900">Detail Tidak KB ({{ count($noKbCases) }} orang)</h3>
                                ...
                                <dd class="group relative">
                                    ...
                                    <div class="hidden group-hover:block absolute z-50 mt-2 w-full sm:w-96 tright-0 sm:right-0 transform sm:origin-top-right">
                                        <div class="bg-white rounded-lg shadow-xl border border-gray-200 p-4 max-h-96 overflow-y-auto">
                                            <!-- Header tooltip -->
                                            <div class="pb-3 mb-3 border-b border-gray-200">
                                                <h3 class="text-lg font-semibold text-gray-900">Detail BUMIL ({{ count($pregnantCases) }} orang)</h3>
                                            </div>
                                ...
                                <dd class="group relative">
                                    ...
                                    <div class="hidden group-hover:block absolute z-50 mt-2 w-full sm:w-96 tright-0 sm:right-0 transform sm:origin-top-right">
                                        <div class="bg-white rounded-lg shadow-xl border border-gray-200 p-4 max-h-96 overflow-y-auto">
                                            <!-- Header tooltip -->
                                            <div class="pb-3 mb-3 border-b border-gray-200">
                                                <h3 class="text-lg font-semibold text-gray-900">Detail ({{ count($healthFacilityBirthCases) }} orang)</h3>
                                            </div>
                                ...
                                <dd class="group relative">
                                    ...
                                    <div class="hidden group-hover:block absolute z-50 mt-2 w-full sm:w-96 tright-0 sm:right-0 transform sm:origin-top-right">
                                        <div class="bg-white rounded-lg shadow-xl border border-gray-200 p-4 max-h-96 overflow-y-auto">
                                            <!-- Header tooltip -->
                                            <div class="pb-3 mb-3 border-b border-gray-200">
                                                <h3 class="text-lg font-semibold text-gray-900">Detail ({{ count($exclusiveBreastfeedingCases) }} anak)</h3>
                                            </div>
                                            ...
                                            <!-- Footer pagination -->
                                            @if(count($exclusiveBreastfeedingCases) > 10)
                                                <div class="pt-3 mt-3 border-t border-gray-200 text-center">
                                                    <p class="text-sm text-blue-600 font-medium">
                                                        Menampilkan 10 dari {{ $stats['exclusive_breastfeeding'] }} kasus
                                                    </p>
                                                </div>
                                            @endif
                                        </div>
                                ...
                                <dd class="group relative">
                                    ...
                                    <div class="hidden group-hover:block absolute z-50 mt-2 w-full sm:w-96 tright-0 sm:right-0 transform sm:origin-top-right">
                                        <div class="bg-white rounded-lg shadow-xl border border-gray-200 p-4 max-h-96 overflow-y-auto">
                                            <!-- Header tooltip -->
                                            <div class="pb-3 mb-3 border-b border-gray-200">
                                                <h3 class="text-lg font-semibold text-gray-900">Detail Imunisasi Lengkap ({{ count($completeImmunizationCases) }} anak)</h3>
                                            </div>
                                            ...
                                            <!-- Footer pagination -->
                                            @if(count($completeImmunizationCases) > 10)
                                                <div class="pt-3 mt-3 border-t border-gray-200 text-center">
                                                    <p class="text-sm text-blue-600 font-medium">
                                                        Menampilkan 10 dari {{ $stats['exclusive_breastfeeding'] }} kasus
                                                    </p>
                                ...
                                <dd class="group relative">
                                    ...
                                    <div class="hidden group-hover:block absolute z-50 mt-2 w-full sm:w-96 tright-0 sm:right-0 transform sm:origin-top-right">
                                        <div class="bg-white rounded-lg shadow-xl border border-gray-200 p-4 max-h-96 overflow-y-auto">
                                            <!-- Header tooltip -->
                                            <div class="pb-3 mb-3 border-b border-gray-200">
                                                <h3 class="text-lg font-semibold text-gray-900">Detail Pemantauan Pertumbuhan ({{ count($growthMonitoringCases) }} anak)</h3>
                                            </div>
                                            ...
                                            <!-- Footer pagination -->
                                            @if(count($growthMonitoringCases) > 10)
                                                <div class="pt-3 mt-3 border-t border-gray-200 text-center">
                                                    <p class="text-sm text-blue-600 font-medium">
                                                        Menampilkan 10 dari {{ $stats['exclusive_breastfeeding'] }} kasus
                                                    </p>
                                    ...
                                    <div class="hidden group-hover:block absolute z-50 mt-2 w-full sm:w-96 tright-0 sm:right-0 transform sm:origin-top-right">
                                        <div class="bg-white rounded-lg shadow-xl border border-gray-200 p-4 max-h-96 overflow-y-auto">
                                            ...
                                            @if(count($kbCases) > 10)
                                                <div class="pt-3 mt-3 border-t border-gray-200 text-center">
                                                    <p class="text-sm text-blue-600 font-medium">
                                                        Menampilkan 10 dari {{ $maternalStats['kb_count'] }} kasus
                                                    </p>
                                                </div>
                                            @endif
                                        </div>
                                ...
                                <dd class="group relative">
                                    ...
                                    <div class="hidden group-hover:block absolute z-50 mt-2 w-full sm:w-96 tright-0 sm:right-0 transform sm:origin-top-right">
                                        <div class="bg-white rounded-lg shadow-xl border border-gray-200 p-4 max-h-96 overflow-y-auto">
                                            ...
                                            <!-- Footer pagination -->
                                            @if(count($noKbCases) > 10)
                                                <div class="pt-3 mt-3 border-t border-gray-200 text-center">
                                                    <p class="text-sm text-blue-600 font-medium">
                                                        Menampilkan 10 dari {{ $maternalStats['no_kb_count'] }} kasus
                                                    </p>
                                                </div>
                                            @endif
                                        </div>
                                    ...
                                    <div class="hidden group-hover:block absolute z-50 mt-2 w-full sm:w-96 tright-0 sm:right-0 transform sm:origin-top-right">
                                        <div class="bg-white rounded-lg shadow-xl border border-gray-200 p-4 max-h-96 overflow-y-auto">
                                            ...
                                            @if(count($pregnantCases) > 10)
                                                <div class="pt-3 mt-3 border-t border-gray-200 text-center">
                                                    <p class="text-sm text-blue-600 font-medium">
                                                        Menampilkan 10 dari {{ $maternalStats['pregnant_count'] }} kasus
                                                    </p>
                                                </div>
                                            @endif
                                        </div>
                                ...
                                <dd class="group relative">
                                    ...
                                    <div class="hidden group-hover:block absolute z-50 mt-2 w-full sm:w-96 tright-0 sm:right-0 transform sm:origin-top-right">
                                        <div class="bg-white rounded-lg shadow-xl border border-gray-200 p-4 max-h-96 overflow-y-auto">
                                                            ...
                                                            <div class="col-span-1 sm:col-span-2 mt-2">
                                                                @auth
                                                                    <a href="{{ route('family-members.show', $case) }}" class="inline-flex items-center px-3 py-1.5 border border-blue-600 text-xs font-medium rounded-md text-blue-600 bg-white hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200">
                                                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                                                                        </svg>
                                                                        Lihat Profil Lengkap
                                                                    </a>
                                                                @endauth
                                            ...
                                            <!-- Footer pagination -->
                                            @if(count($healthFacilityBirthCases) > 10)
                                                <div class="pt-3 mt-3 border-t border-gray-200 text-center">
                                                    <p class="text-sm text-blue-600 font-medium">
                                                        Menampilkan 10 dari {{ $maternalStats['health_facility_birth_count'] }} kasus
                                                    </p>
                                                </div>
                                            @endif
                                        </div>
                                    ...
                                    <div class="hidden group-hover:block absolute z-50 mt-2 w-full sm:w-96 tright-0 sm:right-0 transform sm:origin-top-right">
                                        <div class="bg-white rounded-lg shadow-xl border border-gray-200 p-4 max-h-96 overflow-y-auto">
                                            ...
                                            @if(count($exclusiveBreastfeedingCases) > 10)
                                                <div class="pt-3 mt-3 border-t border-gray-200 text-center">
                                                    <p class="text-sm text-blue-600 font-medium">
                                                        Menampilkan 10 dari {{ $childStats['exclusive_breastfeeding_count'] }} kasus
                                                    </p>
                                                </div>
                                            @endif
                                        </div>
                                    ...
                                    <div class="hidden group-hover:block absolute z-50 mt-2 w-full sm:w-96 tright-0 sm:right-0 transform sm:origin-top-right">
                                        <div class="bg-white rounded-lg shadow-xl border border-gray-200 p-4 max-h-96 overflow-y-auto">
                                            ...
                                            @if(count($completeImmunizationCases) > 10)
                                                <div class="pt-3 mt-3 border-t border-gray-200 text-center">
                                                    <p class="text-sm text-blue-600 font-medium">
                                                        Menampilkan 10 dari {{ $childStats['complete_immunization_count'] }} kasus
                                                    </p>
                                                </div>
                                            @endif
                                        </div>
                                    ...
                                    <div class="hidden group-hover:block absolute z-50 mt-2 w-full sm:w-96 tright-0 sm:right-0 transform sm:origin-top-right">
                                        <div class="bg-white rounded-lg shadow-xl border border-gray-200 p-4 max-h-96 overflow-y-auto">
                                            ...
                                            @if(count($growthMonitoringCases) > 10)
                                                <div class="pt-3 mt-3 border-t border-gray-200 text-center">
                                                    <p class="text-sm text-blue-600 font-medium">
                                                        Menampilkan 10 dari {{ $childStats['growth_monitoring_count'] }} kasus
                                                    </p>
                                                </div>
                                            @endif
                                        </div>

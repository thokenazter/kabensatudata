...
class FamilyMember extends Model
{
    ...
    protected $casts = [
        ...
        'has_diabetes_mellitus' => 'boolean',
        'takes_dm_medication_regularly' => 'boolean',
        'has_mental_disorder' => 'boolean',
        'takes_mental_disorder_medication_regularly' => 'boolean',
        'is_at_risk_for_hiv' => 'boolean',
        ...
        'last_maternity_service_date' => 'date',
        'last_neonatal_visit_date' => 'date',
        'last_child_growth_monitoring_date' => 'date',
        'last_school_screening_date' => 'date',
        'last_productive_age_screening_date' => 'date',
        'last_elderly_screening_date' => 'date',
        'last_hiv_screening_date' => 'date',
        'last_tb_screening_date' => 'date',
    ];
